...
weights = {
  'signal'         : '%f*sf_pu*sf_tt*normalizedWeight*sf_lepID*sf_lepIso*sf_lepTrack*sf_ewkV*1*sf_metTrig',
  'w'              : '%f*sf_pu*sf_tt*normalizedWeight*sf_lepID*sf_lepIso*sf_lepTrack*sf_ewkV*1',
  'z'              : '%f*sf_pu*sf_tt*normalizedWeight*sf_lepID*sf_lepIso*sf_lepTrack*sf_ewkV*1',
  'photon'         : '%f*sf_pu*normalizedWeight*sf_ewkV*sf_qcdVVBF*sf_pho*sf_phoTrig *sf_qcdVVBF2j', # add the additional 2-jet kfactor
}

for x in ['dimuon','dielectron','singlemuon','singleelectron','signal']:
	if 'electron' in x:
