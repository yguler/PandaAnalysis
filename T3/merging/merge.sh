...
#echo MET SinglePhoton SingleElectron TTbar ZtoNuNu ZJets GJets WJets SingleTop QCD Diboson TTbar_isrup TTbar_isrdown TTbar_tuneup TTbar_tunedown | xargs -n 1 -P 12 python merge.py
