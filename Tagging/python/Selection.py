...
cuts = {
    ...
    'mistag'        : tAND(presel,'nLooseLep==1 && nTightMuon==1 && nLooseElectron==0 && nLoosePhoton==0 && pfUWmag>250 && fj1MaxCSV<0.54 && isojetNBtags==0 && dphipfUW>0.5 && fabs(calomet-pfmet)/pfUWmag<0.5 && mT<160'),
