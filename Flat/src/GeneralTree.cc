...
void GeneralTree::ReadTree(TTree *t) {
	...
	treePtr->SetBranchAddress("sf_sjcsvWeightB",&sf_sjcsvWeightB);
	treePtr->SetBranchStatus("sf_sjcsvWeightM",1);
	treePtr->SetBranchAddress("sf_sjcsvWeightM",&sf_sjcsvWeightM);
	treePtr->SetBranchStatus("sf_csvWeightB",1);
	treePtr->SetBranchAddress("sf_csvWeightB",&sf_csvWeightB);
	treePtr->SetBranchStatus("sf_csvWeightM",1);
	treePtr->SetBranchAddress("sf_csvWeightM",&sf_csvWeightM);
	treePtr->SetBranchStatus("sf_sjcsvWeightBUp",1);
	treePtr->SetBranchAddress("sf_sjcsvWeightBUp",&sf_sjcsvWeightBUp);
	treePtr->SetBranchStatus("sf_sjcsvWeightMUp",1);
	treePtr->SetBranchAddress("sf_sjcsvWeightMUp",&sf_sjcsvWeightMUp);
	treePtr->SetBranchStatus("sf_csvWeightBUp",1);
	treePtr->SetBranchAddress("sf_csvWeightBUp",&sf_csvWeightBUp);
	treePtr->SetBranchStatus("sf_csvWeightMUp",1);
	treePtr->SetBranchAddress("sf_csvWeightMUp",&sf_csvWeightMUp);
	treePtr->SetBranchStatus("sf_sjcsvWeightBDown",1);
	treePtr->SetBranchAddress("sf_sjcsvWeightBDown",&sf_sjcsvWeightBDown);
	treePtr->SetBranchStatus("sf_sjcsvWeightMDown",1);
	treePtr->SetBranchAddress("sf_sjcsvWeightMDown",&sf_sjcsvWeightMDown);
	treePtr->SetBranchStatus("sf_csvWeightBDown",1);
	treePtr->SetBranchAddress("sf_csvWeightBDown",&sf_csvWeightBDown);
	treePtr->SetBranchStatus("sf_csvWeightMDown",1);
	treePtr->SetBranchAddress("sf_csvWeightMDown",&sf_csvWeightMDown);
	...
	treePtr->SetBranchStatus("sf_btagGT0",1);
	treePtr->SetBranchAddress("sf_btagGT0",&sf_btagGT0);
	treePtr->SetBranchStatus("sf_btagGT0BUp",1);
	treePtr->SetBranchAddress("sf_btagGT0BUp",&sf_btagGT0BUp);
	treePtr->SetBranchStatus("sf_btagGT0BDown",1);
	treePtr->SetBranchAddress("sf_btagGT0BDown",&sf_btagGT0BDown);
	treePtr->SetBranchStatus("sf_btagGT0MUp",1);
	treePtr->SetBranchAddress("sf_btagGT0MUp",&sf_btagGT0MUp);
	treePtr->SetBranchStatus("sf_btagGT0MDown",1);
	treePtr->SetBranchAddress("sf_btagGT0MDown",&sf_btagGT0MDown);
	...
	treePtr->SetBranchStatus("sf_btagGT0_alt",1);
	treePtr->SetBranchAddress("sf_btagGT0_alt",&sf_btagGT0_alt);
	treePtr->SetBranchStatus("sf_btagGT0BUp_alt",1);
	treePtr->SetBranchAddress("sf_btagGT0BUp_alt",&sf_btagGT0BUp_alt);
	treePtr->SetBranchStatus("sf_btagGT0BDown_alt",1);
	treePtr->SetBranchAddress("sf_btagGT0BDown_alt",&sf_btagGT0BDown_alt);
	treePtr->SetBranchStatus("sf_btagGT0MUp_alt",1);
	treePtr->SetBranchAddress("sf_btagGT0MUp_alt",&sf_btagGT0MUp_alt);
	treePtr->SetBranchStatus("sf_btagGT0MDown_alt",1);
	treePtr->SetBranchAddress("sf_btagGT0MDown_alt",&sf_btagGT0MDown_alt);
	...
	treePtr->SetBranchStatus("sf_sjbtagGT0",1);
	treePtr->SetBranchAddress("sf_sjbtagGT0",&sf_sjbtagGT0);
	treePtr->SetBranchStatus("sf_sjbtagGT0BUp",1);
	treePtr->SetBranchAddress("sf_sjbtagGT0BUp",&sf_sjbtagGT0BUp);
	treePtr->SetBranchStatus("sf_sjbtagGT0BDown",1);
	treePtr->SetBranchAddress("sf_sjbtagGT0BDown",&sf_sjbtagGT0BDown);
	treePtr->SetBranchStatus("sf_sjbtagGT0MUp",1);
	treePtr->SetBranchAddress("sf_sjbtagGT0MUp",&sf_sjbtagGT0MUp);
	treePtr->SetBranchStatus("sf_sjbtagGT0MDown",1);
	treePtr->SetBranchAddress("sf_sjbtagGT0MDown",&sf_sjbtagGT0MDown);
	...
	treePtr->SetBranchStatus("isojet2Pt",1);
	treePtr->SetBranchAddress("isojet2Pt",&isojet2Pt);
	treePtr->SetBranchStatus("isojet2CSV",1);
	treePtr->SetBranchAddress("isojet2CSV",&isojet2CSV);
	treePtr->SetBranchStatus("isojet2Flav",1);
	treePtr->SetBranchAddress("isojet2Flav",&isojet2Flav);
