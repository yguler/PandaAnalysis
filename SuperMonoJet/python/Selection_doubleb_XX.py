...
baseline = 'metFilter==1 && nFatjet==1 && fj1Pt>200 && nTau==0 && Sum$(jetPt>30 && jetIso)<2 && fj1MSD_corr>XX_MS1_XX && fj1MSD_corr<XX_MS2_XX'
...
cuts['tm'] = tAND(baseline,'(nLooseElectron+nLoosePhoton+nTau)==0 && nLooseMuon==1 && looseLep1IsTight==1 && puppiUWmag>200 && isojetNBtags==1 && dphipuppiUW>0.4 && fj1DoubleCSV>0.75')
cuts['tm_fail'] = tAND(baseline,'(nLooseElectron+nLoosePhoton+nTau)==0 && nLooseMuon==1 && looseLep1IsTight==1 && puppiUWmag>200 && isojetNBtags==1 && dphipuppiUW>0.4 && fj1DoubleCSV<0.75')
cuts['te'] = tAND(baseline,'(nLooseMuon+nLoosePhoton+nTau)==0 && nLooseElectron==1 && looseLep1IsTight==1 && puppiUWmag>200 && isojetNBtags==1 && dphipuppiUW>0.4 && puppimet>50 && fj1DoubleCSV>0.75')
cuts['te_fail'] = tAND(baseline,'(nLooseMuon+nLoosePhoton+nTau)==0 && nLooseElectron==1 && looseLep1IsTight==1 && puppiUWmag>200 && isojetNBtags==1  && dphipuppiUW>0.4 && puppimet>50 && fj1DoubleCSV<0.75')
cuts['wmn'] = tAND(baseline,'(nLooseElectron+nLoosePhoton+nTau)==0 && nLooseMuon==1 && looseLep1IsTight==1 && puppiUWmag>200 && isojetNBtags==0 && dphipuppiUW>0.4 && fj1DoubleCSV>0.75')
cuts['wen'] = tAND(baseline,'(nLooseMuon+nLoosePhoton+nTau)==0 && nLooseElectron==1 && looseLep1IsTight==1 && puppiUWmag>200 && isojetNBtags==0 && dphipuppiUW>0.4 && puppimet>50 && fj1DoubleCSV>0.75')
cuts['wmn_fail'] = tAND(baseline,'(nLooseElectron+nLoosePhoton+nTau)==0 && nLooseMuon==1 && looseLep1IsTight==1 && puppiUWmag>200 && isojetNBtags==0 && dphipuppiUW>0.4 && fj1DoubleCSV<0.75')
cuts['wen_fail'] = tAND(baseline,'(nLooseMuon+nLoosePhoton+nTau)==0 && nLooseElectron==1 && looseLep1IsTight==1 && puppiUWmag>200 && isojetNBtags==0 && dphipuppiUW>0.4 && puppimet>50 && fj1DoubleCSV<0.75')
cuts['zmm'] = tAND(baseline,'(nLooseElectron+nLoosePhoton+nTau)==0 && nLooseMuon==2 && looseLep1IsTight==1 && puppiUZmag>200 && isojetNBtags==0 && dphipuppiUZ>0.4 && diLepMass>60 && diLepMass<120 && fj1DoubleCSV>0.75')
cuts['zee'] = tAND(baseline,'(nLooseMuon+nLoosePhoton+nTau)==0 && nLooseElectron==2 && looseLep1IsTight==1 && puppiUZmag>200 && isojetNBtags==0 && dphipuppiUZ>0.4 && diLepMass>60 && diLepMass<120 && fj1DoubleCSV>0.75')
cuts['zmm_fail'] = tAND(baseline,'(nLooseElectron+nLoosePhoton+nTau)==0 && nLooseMuon==2 && looseLep1IsTight==1 && puppiUZmag>200 && isojetNBtags==0 && dphipuppiUZ>0.4 && diLepMass>60 && diLepMass<120 && fj1DoubleCSV<0.75')
cuts['zee_fail'] = tAND(baseline,'(nLooseMuon+nLoosePhoton+nTau)==0 && nLooseElectron==2 && looseLep1IsTight==1 && puppiUZmag>200 && isojetNBtags==0 && dphipuppiUZ>0.4 && diLepMass>60 && diLepMass<120 && fj1DoubleCSV<0.75')
cuts['pho'] = tAND(baseline,'(nLooseMuon+nLooseElectron+nTau)==0 && nLoosePhoton==1 && loosePho1IsTight==1 && puppiUAmag>200 && isojetNBtags==0 && dphipuppiUA>0.4 && fj1DoubleCSV>0.75')
cuts['pho_fail'] = tAND(baseline,'(nLooseMuon+nLooseElectron+nTau)==0 && nLoosePhoton==1 && loosePho1IsTight==1 && puppiUAmag>200 && isojetNBtags==0 && dphipuppiUA>0.4 && fj1DoubleCSV<0.75')
...
weights['tm_fail'] = tTIMES(weights['base'],'%f*sf_metTrig*sf_lepID*sf_lepIso*sf_lepTrack*sf_tt*sf_btag1')
weights['te'] = tTIMES(weights['base'],'%f*sf_eleTrig*sf_lepID*sf_lepTrack*sf_tt*sf_btag1')
weights['te_fail'] = tTIMES(weights['base'],'%f*sf_eleTrig*sf_lepID*sf_lepTrack*sf_tt*sf_btag1')
...
weights['pho_fail'] = tTIMES(weights['base'],'%f*sf_phoTrig*sf_btag0*1.0')


for r in ['signal','wmn','wen','tm','tm_fail','te_fail','te','zmm','zee','zmm_fail','zee_fail','wmn_fail','wen_fail','pho','pho_fail']:
    print r
