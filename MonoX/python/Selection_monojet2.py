...
cuts['SR0'] = tAND(baseline,tAND(calocutSR,'nLooseLep==0 && nLooseElectron==0 && nLoosePhoton==0 && jetNMBtags==0 && jet1Pt>100 && abs(jet1Eta)<2.5 && dphipfmet>0.5 && pfUmag>250'))
...
cuts['PhoINC'] = tAND(baseline,'nLoosePhoton==1 && loosePho1IsTight==1')
...
cuts['ZeeCR'] = tAND(cuts['ZeeINC'],tAND(calocutZ,'(nLooseMuon+nLoosePhoton+nTau)==0 && pfUZmag>250 && dphipfUZ>0.5 && jet1Pt>100 && abs(jet1Eta)<2.5'))
cuts['WmnCR'] = tAND(cuts['WmnINC'],tAND(calocutW,'(nLooseElectron+nLoosePhoton+nTau)==0 && pfUWmag>250 && dphipfUW>0.5 && jet1Pt>100 && abs(jet1Eta)<2.5'))
cuts['WenCR'] = tAND(cuts['WenINC'],tAND(calocutW,'(nLooseMuon+nLoosePhoton+nTau)==0 && pfUWmag>250 && dphipfUW>0.5 && jet1Pt>100 && abs(jet1Eta)<2.5'))
cuts['PhoCR'] = tAND(cuts['PhoINC'],tAND(calocutA,'(nLooseMuon+nLooseElectron+nTau)==0 && pfUAmag>250 && dphipfUA>0.5 && jet1Pt>100 && abs(jet1Eta)<2.5'))
...
weights['PhoINC'] = tTIMES(weights['base'],'%f*sf_eleTrig*sf_lepID*sf_lepIso*sf_lepTrack*sf_tt')
...
weights['PhoCR'] = tTIMES(weights['PhoINC'],'%f*sf_Medbtag0')

#b-tag shift
for r in ['SR0','ZmmCR','ZeeCR','WmnCR','WenCR','PhoCR']:
